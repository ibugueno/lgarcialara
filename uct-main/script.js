...
const allSong = [
  "./assets/04_lorenzo_maripil.mid",
  "./assets/05_herminia_huarapil.mid",
  "./assets/8.-Coro-de-mujeres.mid",
  "./assets/02_manuel_levipil.mid",
  "./assets/03_genoveva_neculman.mid",
  "./assets/17.-Canto.mid",
  "./assets/mapuche-guillatun.mid",
  "./assets/15.-Conjuro.mid",
  "./assets/mapuche-canto.mid",
  "./assets/18.-Canto-de-hombre.mid",
  "./assets/2.-Canto-de-mujer-haciendo.mid",
  "./assets/5.-Canto-de-mujer.mid",
  "./assets/mapuche-trutruca.mid",
  "./assets/16.-Canto.mid",
  "./assets/7.-Canto-de-mujer.mid",
  "./assets/11.-Canto-de-mujer.mid",
  "./assets/10.-Canto-de-mujer.mid",
  "./assets/6.-Canto-de-mujer.mid",
  "./assets/4.-Canto-de-mujer-al-lonco.mid",
  "./assets/14.-Canto-de-mujer.mid",
  "./assets/9.-Canto-imitando.mid",
  "./assets/1.-Coro-de-mujeres.-Carmen-Arango.mid",
  "./assets/mapuche-nolkin.mid",
  "./assets/3.-Canto-de-mujer-al-cahuel.mid",
];
...
function nextSong() {
  ...
  getSong(allSong[currentSongIndex]).then(() => changeSong(currentSongIndex));
}
...
function updateCanvas(songData) {
  document.querySelector(".song-title").textContent = songData.fileName.replace(
    "./assets/",
    ""
  );
...
function getRandomMidiFilename() {
  return `${FILE_PREFIX}/3.-Canto-de-mujer-al-cahuel.mid`;
